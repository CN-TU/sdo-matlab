function [ y ] = sdo_apply_model( data, observers, x, ynorm )
% SDO_APPLY_MODEL uses a model (set of observers) to calculate 
% outlierness scores in new data 
% FIV (TU Wien), Dec 2017
%   
% Inputs:
